...
public class ToyTaserItem extends UhcModElements.ModElement {
	...
	@ObjectHolder("uhc:toy_taser")
	public static final Item block = null;

	@ObjectHolder("uhc:entitybullettoy_taser")
	public static final EntityType arrow = null;

	public ToyTaserItem(UhcModElements instance) {
		super(instance, 10);
	}
	...
	public void initElements() {
		...
		elements.entities.add(() -> (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
				...
				.size(0.5f, 0.5f)).build("entitybullettoy_taser").setRegistryName("entitybullettoy_taser"));
	}
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		public ItemStack getItem() {
			return new ItemStack(TaserBoltNotAmmoItem.block, (int) (1));
		}
