...
public class ToyGunItemItem extends UhcModElements.ModElement {
	@ObjectHolder("uhc:toy_gun_item")
	public static final Item block = null;
	@ObjectHolder("uhc:entitybullettoy_gun_item")
	public static final EntityType arrow = null;
	public ToyGunItemItem(UhcModElements instance) {
		super(instance, 6);
	}
	...
	public void initElements() {
		...
		elements.entities.add(() -> (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
				...
				.size(0.5f, 0.5f)).build("entitybullettoy_gun_item").setRegistryName("entitybullettoy_gun_item"));
	}
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			super(new Item.Properties().group(ToysItemGroup.tab).maxDamage(100));
			setRegistryName("toy_gun_item");
		}
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		public ItemStack getItem() {
			return new ItemStack(DartItem.block, (int) (1));
		}
