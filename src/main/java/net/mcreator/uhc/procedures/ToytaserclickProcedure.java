...
import net.mcreator.uhc.item.ToyTaserItem;
...
public class ToytaserclickProcedure extends UhcModElements.ModElement {
	public ToytaserclickProcedure(UhcModElements instance) {
		super(instance, 12);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				UhcMod.LOGGER.warn("Failed to load dependency entity for procedure Toytaserclick!");
			return;
		}
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				UhcMod.LOGGER.warn("Failed to load dependency world for procedure Toytaserclick!");
			return;
		}
					...
					for (int _idx = 0; _idx < _iitemhandlerref.get().getSlots(); _idx++) {
						...
						if (((Amount_Of_Item_Needed) > 39)) {
							if (((ItemBought) == (false))) {
								...
								if (entity instanceof PlayerEntity) {
									ItemStack _setstack = new ItemStack(ToyTaserItem.block, (int) (1));
